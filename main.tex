...
\begin{dtuposterhead} %
\dtuposterauthor{Thjalfe Ulvenberg\textsuperscript{1,*}, Second Author\textsuperscript{2}}
\dtuposteraffil{\textsuperscript{1} Technical University of Denmark, Department of Electrical and Photonics Engineering, Kgs. Lyngby, Denmark}
\dtuposteraffil*{\textsuperscript{*} Corresponding author, Email: jbtul@dtu.dk}
\end{dtuposterhead}
%
%
%======================================================================
